    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-4 col-12 mt-4">
                ...
                <p class="text-center mb-4">Авторизуйтесь, чтобы получить все возможности сервиса</p>
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="form-group">
                        ...
                        <a style="font-size: 0.9em" href="{{ route('password.request') }}">Забыли пароль?</a>
                        @error('password')
                        <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                ...
                <div class="mt-4 text-center">
                    <span class="text-gray">Нет аккаунта?</span> <a href="{{ route("register") }}">Зарегистрироваться</a>
                </div>
            </div>
        </div>
    </div>
